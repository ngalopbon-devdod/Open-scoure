...
function bearlib:MakeWindow(Configs)
    ...
    task.spawn(function()
        ...
        ToggleButton.Image = "rbxassetid://91222518412026"
        ...
        task.spawn(function()
            while _tbStroke and _tbStroke.Parent do
                _tbStroke.Transparency = 0.05 + math.abs(math.sin(tick()*2.5))*0.55
                task.wait(0.04)
            end
        end)
        -- Ten Tay Hub
        local _nameL = Instance.new("TextLabel")
        _nameL.Size = UDim2.new(0,80,0,18)
        _nameL.Position = UDim2.new(0.5,-40,1,4)
        _nameL.BackgroundTransparency = 1
        _nameL.Font = Enum.Font.GothamBold
        _nameL.TextSize = 13
        _nameL.TextColor3 = Color3.fromRGB(0,195,120)
        _nameL.Text = "Tay Hub"
        _nameL.TextStrokeTransparency = 0.5
        _nameL.Parent = ToggleButton
...
local function CreateNotification(Icon, Title, Message, Duration)
    ...
    TitleLabel.Text = Title or "Tay Hub"
...
function bearlib:ResetBorderColors()
    local defaultTheme = self.Themes.vtdroblox
